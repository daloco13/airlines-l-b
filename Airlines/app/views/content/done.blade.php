...
<div class="container">
	...
	of {{ $input["country"] }} , {{ $input["city"] }} , {{ $input["streetaddress"] }}

	You have successfully booked for this flight: {{ Session::get('summary_0') }} {{ Session::get('summary_2') }}
	{{ Session::get('origin') }}
	...
	<div class="col-md-4 panel panel-default">
				...
				<div class="<?php if(Session::get('adult') <= 0) echo "hide"; ?>"><span class='summary-name'>Adult x <span id="intAdult">{{ Session::get('adult'); }}</span></span><span class='summary-right'><span id="adultDep"> &nbsp; {{ $adult }} {{ Session::get('fck') }}</span> Php(Dep) 
